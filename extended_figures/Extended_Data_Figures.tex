...
\inclcrop{challenge1_src/images/WTC11-sqanti-numGenes.pdf}{38pt}{Extended Data Fig. 1}{
  ...
  dataset.
  b) Percentage of known and novel transcripts with full support at junctions and end positions.
...
\inclcrop{challenge1_src/images/WTC11-sqanti-cats.pdf}{38pt}{Extended Data Fig. 2}{
  SQANTI3 classifications of LRGASP submissions on the WTC11 datset.
    a) Percentage of FSM (Full Splice Match) vs ISM (Incomplete Splice Match).
  b) Percentage of NIC (Novel In Catalog) vs NNC (Novel Not in Catalog).
  Ba: Bambu, FM: FLAMES, FL: FLAIR,
  IQ: IsoQuant, IT: IsoTools, IB: Iso_IB, Ly: LyRic, Ma: Mandalorion, TL: TALON-LAPA, Sp:
  Spectra, ST: StringTie2.
}
...
\inclimg{challenge1_src/images/Coverage_all_SIRVs.steps.with-labels.ai.pdf}{Extended Data Fig. 4}{
